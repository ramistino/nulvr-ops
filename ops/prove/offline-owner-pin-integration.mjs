...
import {verifyOwnerPin} from './owner-pin-local.mjs';
...
export function verifyOfflineOwnerPin({rawPayloadJson,payload,signatureBase64,publicKeyPem,anchor,snapshot,actual,seenIds,now}){
 try{
  ...
  const verification=verifyOwnerPin({rawPayloadJson,payload,signatureBase64,publicKeyPem,trustedKeyFingerprint:anchor.keySha256,actual,now});
