...
const HEX=/^[a-f0-9]{64}$/;
export function evaluateOfflineTrust({verification,anchor,snapshot,seenIds,observedKeySha256}){
 ...
 if(!HEX.test(observedKeySha256||'')||observedKeySha256!==anchor.keySha256)return deny('KEY_ANCHOR_MISMATCH');
